 ...
 */
public class RegexPatchedRobotsTxtServer extends RobotstxtServer {

    private static final Logger logger = LoggerFactory.getLogger(RegexPatchedRobotsTxtServer.class);
    ...
    public RegexPatchedRobotsTxtServer(RobotstxtConfig config, PageFetcher pageFetcher) {
        this(config, pageFetcher, 16384);
    }

    public RegexPatchedRobotsTxtServer(RobotstxtConfig config, PageFetcher pageFetcher, int maxBytes) {
        super(config,pageFetcher,maxBytes);
        this.config = config;
        ...
        try {
            ...
            if (fetchResult.getStatusCode() == HttpStatus.SC_OK) {
                ...
                if (Util.hasPlainTextContent(page.getContentType())) {
                    ...
                    directives = PatchedRobotstxtParser.parse(content, config);
