...
/**
 * This class was taken from the original crawler4j framework and was solely
 * altered to fix a bug in its most recent version. The original author is
 * Yasser Ganisaffar.
 *
 ...
 */
public class PatchedRobotstxtParser {

    private static final Logger logger = LoggerFactory.getLogger(PatchedRobotstxtParser.class);
